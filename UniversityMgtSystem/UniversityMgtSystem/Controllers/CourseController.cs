...
namespace UniversityMgtSystem.Controllers
{
    public class CourseController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="CourseId,Code,Name,Description,Credit,DepartmentId,SemesterId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="CourseId,Code,Name,Description,Credit,DepartmentId,SemesterId")] Course course)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            var user = db.Courses.FirstOrDefault(u => u.Code == (string)code);
        ...
        {
            var user = db.Courses.FirstOrDefault(u => u.Name == (string)name);
